...
int main()
{
    ...
    Billet b1(2,100.0,&t1,&norm1);
    Billet b2(5,200.0,&t2,&norm2);
    Billet b3(6,100.0,&t1,&insu1);
    Billet b4(2,200.0,&t2,&insu3);
    Billet b5(1,100.0,&t1,&norm3);
    Billet b6(3,200.0,&t3,&insusecond1);
